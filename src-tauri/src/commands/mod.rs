...
pub use character::{UserProfile, CharacterBrief, get_user_profile, save_user_profile, check_and_update_profile, trigger_profile_update, trigger_profile_update_command, get_current_character, switch_character, list_character_briefs, get_current_character_voice_id, increment_conversation_count};

// TTS commands
pub use tts::{
    get_tts_config, save_tts_config, get_voice_config, save_voice, delete_voice,
    tts_speak, tts_speak_with_emotion, clear_tts_cache, get_tts_cache_info,
